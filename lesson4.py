...
# Если размерность данных > 2, то используют иерархическую интексацию (мультииндекс). В один индекс включается несколько уровней.
...
# - по первому городу и первым двум person-ам (через срезы)
